...
static const DWORD  ACHIEVEMENT_COUNT = 8;
...
public:
       ...
       BOOL& bHandled )
    {
		...
		else if (hObjPressed == m_ToggleSixButton)
		{
    ...
    HRESULT OnInit( XUIMessageInit* pInitData, BOOL& bHandled )
    {
		...
		GetChildById( L"XuiToggleSixButton", &m_ToggleSixButton);
...
//--------------------------------------------------------------------------------------
HRESULT CVBA360App::RegisterXuiClasses()
{
...
//--------------------------------------------------------------------------------------
HRESULT CVBA360App::UnregisterXuiClasses()
{
...
void DoAchievo(DWORD AchievoID)
{
