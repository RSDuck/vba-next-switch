...
static __inline void lq2x_16_def(u16* __restrict dst0, u16* __restrict  dst1, const u16* src0, const u16* src1, const u16* src2, unsigned count)
{
  unsigned i;
...
static __inline void lq2x_32_def(u32* __restrict dst0, u32* __restrict dst1, const u32* __restrict src0, const u32* __restrict src1, const u32* __restrict src2, unsigned count)
{
  unsigned i;
...
void lq2x(u8 *srcPtr, u32 srcPitch, u8 * /* deltaPtr */,
          u8 * __restrict dstPtr, u32 dstPitch, int width, int height)
{
  u16 *dst0 = (u16 *)dstPtr;
  u16 *dst1 = dst0 + (dstPitch >> 1);
