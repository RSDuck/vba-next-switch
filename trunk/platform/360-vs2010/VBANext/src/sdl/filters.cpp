...
extern void AdMame2x(u8*,u32,u8*,u8* __restrict,u32,int,int);
extern void AdMame2x32(u8*,u32,u8*,u8* __restrict,u32,int,int);
//extern void Bilinear(u8*,u32,u8*,u8*,u32,int,int);
//extern void Bilinear32(u8*,u32,u8*,u8* __restrict,u32,int,int);
//extern void BilinearPlus(u8*,u32,u8*,u8* __restrict ,u32,int,int);
...
extern void lq2x(u8*,u32,u8*,u8 * __restrict,u32,int,int);
extern void lq2x32(u8*,u32,u8*,u8* __restrict ,u32,int,int);
...
template<typename T>
void sdlStretchx1(u8 *src, u8 * __restrict dest, int width)
{
  T *s = (T *)src;
  T *d = (T *)dest;
  for(int i = 0; i < width; i++)
...
template<typename T>
void sdlStretchx2(u8 *src, u8 * __restrict dest, int width)
{
  T * s = (T *)src;
  T * d = (T *)dest;
  for(int i = 0; i < width; i++) {
...
template<typename T>
void sdlStretchx3(u8 *src, u8 * __restrict dest, int width)
{
  T *s = (T *)src;
  T *d = (T *)dest;
  for(int i = 0; i < width; i++) {
...
template<typename T>
void sdlStretchx4(u8 *src, u8 * __restrict dest, int width)
{
  T *s = (T *)src;
  T *d = (T *)dest;
  for(int i = 0; i < width; i++) {
...
void sdlStretch24x1(u8 *src, u8 * __restrict dest, int width)
{
  u8 *s = src;
  u8 *d = dest;
  for(int i = 0; i < width; i++) {
...
void sdlStretch24x2(u8 *src, u8 * __restrict dest, int width)
{
  u8 *s = (u8 *)src;
  u8 *d = (u8 *)dest;
  for(int i = 0; i < width; i++) {
...
void sdlStretch24x3(u8 *src, u8 * __restrict dest, int width)
{
  u8 *s = (u8 *)src;
  u8 *d = (u8 *)dest;
  for(int i = 0; i < width; i++) {
...
void sdlStretch24x4(u8 *src, u8 * __restrict dest, int width)
{
  u8 *s = (u8 *)src;
  u8 *d = (u8 *)dest;
  for(int i = 0; i < width; i++) {
...
void sdlStretch2x(u8 *srcPtr, u32 srcPitch, u8 * /* deltaPtr */, u8 * __restrict dstPtr, u32 dstPitch, int width, int height) {
    int i;
#ifndef C_CORE
    u32 *stretcher = (u32 *)sdlStretcher;
#endif
