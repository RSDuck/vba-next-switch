...
static inline void gfxDrawSprites()
{
  ...
  //Begin of GFX Clear Array
  CLEAR_ARRAY(line[lineOBJ]);
  //memset(line[lineOBJ], -1, sizeof(u32) * 240);
  //u32 * lineOBJtmp = line[lineOBJ];
	/*for(unsigned i = 0; i < 240; i += 4)
   {
		*lineOBJtmp++ = 0x80000000;
		*lineOBJtmp++ = 0x80000000;
		*lineOBJtmp++ = 0x80000000;
		*lineOBJtmp++ = 0x80000000;
   }*/
  //End of GFX Clear Array
...
static inline void gfxDrawOBJWin()
{
  ...
  //Begin of GFX Clear Array
	...
	//memset(line[lineOBJ], -1, sizeof(u32) * 240);
  /*u32 * lineOBJWintmp = line[lineOBJWin];
	for(unsigned i = 0; i < 240; i += 4)
   {
		*lineOBJWintmp++ = 0x80000000;
		*lineOBJWintmp++ = 0x80000000;
		*lineOBJWintmp++ = 0x80000000;
		*lineOBJWintmp++ = 0x80000000;
   }*/
