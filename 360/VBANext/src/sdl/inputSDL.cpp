...
#include "inputSDL.h"
#include "../Xbox/Main.h"
#include "../Xbox/RomSettings.h"
#include "../Xbox/InGameOptions.h"
#include "filters.h"
...
extern std::vector<std::string> m_ListData;
extern HXUIOBJ hScene;
extern FilterFunc initFilter(const Filter f, const int colorDepth, const int srcWidth);
