...
inline int dataTicksAccess16(u32 address) // DATA 8/16bits NON SEQ
{
  ...
  else if (busPrefetch)
  {
	...
	u32 val = VariableShiftLeft((busPrefetchCount+1),waitState);

    busPrefetchCount = val - 1;
  }
...
__forceinline int codeTicksAccess16(u32 address) // THUMB NON SEQ
{
  int addr = (address>>24)&15;
...
__forceinline int codeTicksAccess32(u32 address) // ARM NON SEQ
{
  int addr = (address>>24)&15;
...
__forceinline int codeTicksAccessSeq16(u32 address) // THUMB SEQ
{
  int addr = (address>>24)&15;
...
__forceinline int codeTicksAccessSeq32(u32 address) // ARM SEQ
{
  int addr = (address>>24)&15;
...
__forceinline void cpuMasterCodeCheck()
{
