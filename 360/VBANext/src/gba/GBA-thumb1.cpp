...
// AND Rd, Rs
__declspec(noalias) static INSN_REGPARM void thumb40_0(u32 opcode)
{
  int dest = opcode & 7;
...
#endif
static insnfunc_t __declspec(align(128)) thumbInsnTable[1024] = {
...
__declspec(noalias) int thumbExecute()
{
  do {
	  if( cheatsEnabled ) {
		  cpuMasterCodeCheck();
