...
static __forceinline void internal_scale2x_16_def(u16 * __restrict dst, const u16* __restrict src0, const u16* __restrict src1, const u16* __restrict src2, unsigned count) {
  /* first pixel */
  dst[0] = src1[0];
...
static __forceinline void internal_scale2x_32_def(u32* __restrict dst,
                                    const u32* __restrict src0,
                                    const u32* __restrict src1,
                                    const u32* __restrict src2,
                                    unsigned count) 
{
  /* first pixel */
  dst[0] = src1[0];
